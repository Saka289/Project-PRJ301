<%-- 
    Document   : statistics
    Created on : Nov 7, 2022, 11:14:23 PM
    Author     : Saka289
--%>
                        ...
                        <div class="table-responsive">
                            <div class="table-wrapper">
                                <div class="table-title">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <h2 style="color: white"><b>Info about Headphone Store Web</b></h2>
                                        </div>
                                        <div class="col-sm-6">
                            ...
                            <div class="table-wrapper">
                                <div class="table-title">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <h2 style="color: white"><b>Top 5 Users with the most orders</b></h2>
                                        </div>
                                        <div class="col-sm-6">					
                                        </div>
                                    </div>
