        ...
        <script type="text/javascript">
            ...
            function doDelete(id) {
                if (confirm("Are you to delete Product id = " + id)) {
                    window.location = "crudcategory?id=" + id;
                }
            }
            function doEdit(id) {
                window.location = "updatecategory?id=" + id;
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="header-logo">
                                ...
                                <h1 style="color: white;transform: translatey(15px);">Manage Category</h1>
                            </div>
                        </div>
                        ...
                        <div class="table-responsive">
                            <div class="table-wrapper">
                                <div class="table-title">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <h2 style="color: white"><b>Category</b></h2>
                                        </div>
                                        <div class="col-sm-6">
                                            <a href="#editEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="fa fa-pencil-square"></i><span>Edit Category</span></a>
                                        ...
                                        <c:forEach items="${requestScope.listc}" var="c">
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center">
                                                    <img width='100px' height='100px' src="${c.image}" alt="alt"/>
                                                </td>
                                                <td  style="text-align: center">                                      
                                                    <a onclick="doDelete('${c.id}')" class="delete" data-toggle="modal"><i class="fa fa-trash" data-toggle="tooltip" title="Delete"></i></a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                ...
                                <div class="clearfix">
                                    ...
                                    <ul class="pagination">
                                        <c:forEach begin="1" end="${requestScope.num}" var="i">
                                            <li class="page-item"><a href="managecategory?page=${i}" class="page-link">${i}</a></li>
                                            </c:forEach>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="modal-content">
                                <form action="crudcategory" method="post">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            <label>Image</label>
                                            <textarea name="image" class="form-control"></textarea>
                                        </div>				
                                    </div>
                                    <div class="modal-footer">
                                        <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
